...
df = pd.DataFrame(lineup_list, columns = ['Player1', 'Player2', 'Player3', 'Player4', 'Player5', 'Team', 'GP', 'MP', 'POSS', 'DPOSS', 'DFGM', 'DFGA', 'D3PM', 'D3PA', 'DFTM', 'DFTA', 'DPTS'])
df.to_csv('lineups_defensive.csv')
# print df